...
const execute = async (CLI_KEYS, CLI_ARGS) => {
  try {
    ...
    if (checkAndFindVersion(CLI_ARGS)) {
      ...
      console.log("Defaulting to @njs2/base@latest")
      console.log("Did you know now you can pass version to njs2 project command? e.g.: njs2 project <project-name> version 2.0.1")
    }
